"""Composable cross-sectional research backtester."""
...
class ModularBacktester:
    """Compose factor calculation, target-weight generation, and vector execution."""
    ...
    def run(self) -> pd.DataFrame:
        ...
        if self.signal_weights is None:
            raise ValueError("strategy did not produce signal_weights.")
